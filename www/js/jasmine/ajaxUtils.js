...
function jasmineAjaxUtil(Type, Parameter, Domain, uId, uIp)
    {
    ...
    if (self)
		...
		if (window.ActiveXObject)
			self.xmlHttpReq.open('GET', Domain+'/jasmine/publicUtils?t=' + escape(Type) + '&p=' + escape(Parameter) + '&uId=' + escape(uId)  +  '&uIp=' + escape(uIp) + timeStamp(false), false);
		else
			self.xmlHttpReq.open('GET', Domain+'/jasmine/publicUtils?t=' + escape(Type) + '&p=' + escape(Parameter) + '&uId=' + escape(uId) +  '&uIp=' + escape(uIp) , false);
...
function getKioskMessageVersion(g_domain, uId, uIp)
    { 
    return(jasmineAjaxUtil('KioskMessageVersion', null, g_domain, uId, uIp));
    }
