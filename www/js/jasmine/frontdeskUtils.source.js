...
function initScroll(objRefresh, objUp, objDown) {
	...
	pullDownEl = document.getElementById(objDown); //$("#pullDown"); //document.getElementById('pullDown');
	pullUpEl = document.getElementById(objUp); //$("#pullUp");  //document.getElementById('pullUp');
	pullDownOffset = pullDownEl.offsetHeight;
	pullUpOffset = pullUpEl.offsetHeight;

	myScroll = new iScroll(objRefresh, {
		hScrollbar: false, 
		vScrollbar: false,
		useTransition: true,
	...
	myScroll = new iScroll('pull-to-refresh', {
		...
		onScrollEnd: function () {
			if (pullDownEl.className.match('flip')) {
				...
				pullDownEl.querySelector('.pullDownIcon').innerHTML = '&#xe008';
